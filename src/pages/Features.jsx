  ...
  return (
    <div className="min-h-screen flex flex-col items-center overflow-hidden relative bg-gradient-to-br from-white/60 to-primary/10 dark:from-black/60 dark:to-primary/10">
      ...
      <div className="flex-1 w-full flex flex-col items-center justify-center p-8">
        <div className="max-w-3xl w-full bg-white/70 dark:bg-black/40 rounded-2xl shadow-xl p-8 backdrop-blur-md border border-white/20 dark:border-white/10">
          <h1 className="text-4xl font-bold mb-6 text-primary text-center drop-shadow">Features</h1>
          <ul className="space-y-6 text-lg text-gray-800 dark:text-gray-100">
            <li><b>Reading Comprehension:</b> Interactive passages and questions to sharpen your analytical skills.</li>
            <li><b>Synonyms & Antonyms:</b> Practice and master word relationships for vocabulary building.</li>
            <li><b>Vocabulary Builder:</b> Learn essential words with smart repetition and quizzes.</li>
            <li><b>Performance Analytics:</b> Track your progress and identify strengths and weaknesses.</li>
            <li><b>Beautiful UI:</b> Enjoy a modern, glassmorphic interface with theme customization.</li>
          </ul>
        </div>
      </div>
      {/* Footer */}
